...
chatbot_data = {
    ...
    # Science
    "what is gravity": "Gravity is the force that attracts objects towards the center of the Earth or any other celestial body.",
    ...
    "what is dna": "DNA, or deoxyribonucleic acid, is the molecule that carries genetic information in living organisms.",
    # History
    "who was albert einstein": "Albert Einstein was a German-born physicist who developed the theory of relativity.",
    "when did world war ii end": "World War II ended in 1945 with the surrender of Japan.",
    "who was the first president of the united states": "George Washington was the first President of the United States.",
    "what was the industrial revolution": "The Industrial Revolution was a period of major industrialization from the late 18th to early 19th century.",
    "who was cleopatra": "Cleopatra was the last active ruler of the Ptolemaic Kingdom of Egypt.",
    # Geography - Capitals and Facts
    ...
    "capital of south africa": "The capital of South Africa is Cape Town (administrative), Pretoria (executive), and Bloemfontein (judicial).",
    ...
    "what is asia": "Asia is the largest continent by area and population, known for its diverse cultures, languages, and landscapes.",
    "what is europe": "Europe is a continent known for its rich history, art, and political influence, home to many countries and the European Union.",
    "what is africa": "Africa is the second-largest continent, famous for its wildlife, ancient civilizations, and natural resources.",
    "what is the americas": "The Americas include North America, Central America, South America, and the Caribbean, known for diverse ecosystems and cultures.",
    "what is oceania": "Oceania is a region comprising Australia, New Zealand, and numerous Pacific islands, known for its unique wildlife and Polynesian cultures."
}
